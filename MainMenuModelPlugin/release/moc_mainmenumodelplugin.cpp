...
void *MainMenuModelPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IModelPlugin v0.1"))
        return static_cast< IPluginModel*>(const_cast< MainMenuModelPlugin*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    0x9b, 0x0d, 0x00, 0x00, 0x06, 0x00, 'D',  'B', 
    'T',  'o',  'o',  'l',  0x0a, 0x00, 'T',  'a', 
    's',  'k',  'D',  'B',  'T',  'o',  'o',  'l', 
    ...
    '0',  0x00, 0x00, 0x00, 0xc8, 0x00, 0x00, 0x00,
