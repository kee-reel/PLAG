...
PerceptronNetwork::PerceptronNetwork(NetworkParams params) : QObject()
{
    inputLayer = NULL;
    outputLayer = NULL;
...
PerceptronNetwork *PerceptronNetwork::Make(QJsonObject &paramsObj)
{
    ...
    network = new PerceptronNetwork(params);
    return network;
}
...
void PerceptronNetwork::ResetLayers()
{
    if(inputLayer)
    {
        delete inputLayer;
...
float PerceptronNetwork::RunTrainSet()
{   
    resultError = 0;
...
QVector<QVariant> PerceptronNetwork::RunTrainingAndGetResult()
{
    float errBuf = 0;
    int epoch;
...
float PerceptronNetwork::RunTestSet()
{
    resultError = 0;
...
float PerceptronNetwork::RunTrainSet(InputSampleF &trainSet)
{
...
float PerceptronNetwork::RunTestSet(InputSampleF &testSet)
{
...
void PerceptronNetwork::SetupSamplesF(QJsonObject parameters, QVector<InputSampleF> *samples)
{
...
void PerceptronNetwork::SetupSamplesI(QJsonObject parameters, QVector<InputSampleI> *samples)
{
    qDebug() << "This type of data is not digestable by Perceptron :c";
}

bool PerceptronNetwork::SetNetworkParams(QJsonObject params)
{
...
bool PerceptronNetwork::AddLayer(QJsonObject layerParams)
{
