...
void OutputVariable::AddSet(IFuzzyLogicModel::IFuzzySet *set)
{
    setValues.insert(set, 0);
}

void OutputVariable::AddInput(IFuzzyLogicModel::IInputVariable *variable)
{
    inputs.append(variable);
}

void OutputVariable::AddRule(IFuzzyLogicModel::IFuzzyRule *rule)
{
    rules.append(rule);
}
