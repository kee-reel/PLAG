...
IFuzzyLogicModel::IMembershipFunc::FuncType MembershipFunc::GetType()
{
    return type;
}
...
TriangularMembershipFunc::TriangularMembershipFunc(IFuzzyLogicModel::IMembershipFunc::FuncType type, QList<float> definitionPoints)
...
TrapezoidalMembershipFunc::TrapezoidalMembershipFunc(IFuzzyLogicModel::IMembershipFunc::FuncType type, QList<float> definitionPoints)
    : MembershipFunc(type, definitionPoints)
{
    A = definitionPoints.at(0);
    B = definitionPoints.at(1);
