#ifndef IFUZZYLOGICMODEL_H
#define IFUZZYLOGICMODEL_H
...
//! addtogroup FuzzyLogicModel_int
//! {
class IFuzzyLogicModel :
    public IModelPlugin
{
public:
    ...
    public:
        ...
        virtual float GetSetValue(IFuzzyLogicModel::IFuzzySet*set) = 0;
    };
    ...
    public:
        ...
        virtual QMap<IFuzzyLogicModel::IInputVariable*, IFuzzyLogicModel::IFuzzySet*> GetConditions() = 0;
        virtual QMap<IFuzzyLogicModel::IOutputVariable*, IFuzzyLogicModel::IFuzzySet*> GetConsequences() = 0;
...
//! }
Q_DECLARE_INTERFACE(IFuzzyLogicModel, "IFuzzyLogicModel")
#endif // IFUZZYLOGICMODEL_H
