...
QT_MOC_LITERAL(3, 17, 19), // "on_buttonOk_clicked"
QT_MOC_LITERAL(4, 37, 22) // "on_buttonClose_clicked"

    },
    "AddForm\0OnClose\0\0on_buttonOk_clicked\0"
...
void AddForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddForm::OnClose)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AddForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddForm.data,
      qt_meta_data_AddForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
