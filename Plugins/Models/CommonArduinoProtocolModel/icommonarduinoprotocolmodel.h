#ifndef ICOMMONARDUINOPROTOCOLMODEL_H
#define ICOMMONARDUINOPROTOCOLMODEL_H

#include "../../interfaces.h"

//! defgroup CommonArduinoProtocolModel
//!     ingroup MainMenuPlugin_rel_m
//! defgroup CommonArduinoProtocolModel_int Interface
//!     ingroup CommonArduinoProtocolModel
//! defgroup CommonArduinoProtocolModel_imp Implementation
//!     ingroup CommonArduinoProtocolModel

//! addtogroup CommonArduinoProtocolModel_int
//! {
class ICommonArduinoProtocolModel :
    public IModelPlugin
{
public:
    enum PinMode
...
//! }
Q_DECLARE_INTERFACE(ICommonArduinoProtocolModel, "ICommonArduinoProtocolModel")
#endif // ICOMMONARDUINOPROTOCOLMODEL_H
