...
const QMetaObject DraggableButton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DraggableButton.data,
      qt_meta_data_DraggableButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DraggableButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DraggableButton.stringdata0))
        return static_cast<void*>(const_cast< DraggableButton*>(this));
