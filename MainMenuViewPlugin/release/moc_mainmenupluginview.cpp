...
void MainMenuPluginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OpenChildPlugin((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *MainMenuPluginView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IPluginView"))
        return static_cast< IPluginView*>(const_cast< MainMenuPluginView*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'd',  'u',  'l',  'e',  'T',  'y',  'p',  'e', 
    0x08, 0x00, 'T',  'o',  'o',  'l',  'V',  'i', 
    'e',  'w',  0x00, 0x00, 0x9b, 0x0b, 0x00, 0x00,
    0x10, 0x00, 'P',  'a',  'r',  'e',  'n',  't', 
    'M',  'o',  'd',  'u',  'l',  'e',  'N',  'a', 
    'm',  'e',  0x00, 0x00, 0x0d, 0x00, 'M',  'a', 
    'i',  'n',  'M',  'e',  'n',  'u',  'M',  'o', 
    'd',  'e',  'l',  0x00, '(',  0x00, 0x00, 0x00,
